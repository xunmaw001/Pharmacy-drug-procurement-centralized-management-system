<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="卫生局账号" prop="weishengjuzhanghao">
          <el-input v-model="ruleForm.weishengjuzhanghao" 
              placeholder="卫生局账号" clearable  :readonly="ro.weishengjuzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="卫生局账号" prop="weishengjuzhanghao">
              <el-input v-model="ruleForm.weishengjuzhanghao" 
                placeholder="卫生局账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="管辖区域" prop="guanxiaquyu">
          <el-input v-model="ruleForm.guanxiaquyu" 
              placeholder="管辖区域" clearable  :readonly="ro.guanxiaquyu"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  data() {
	...
	zhaopian : false,
      ...
      rules: {
          weishengjuzhanghao: [
                { required: true, message: '卫生局账号不能为空', trigger: 'blur' },
          ],
          mima: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='weishengjuzhanghao'){
            this.ruleForm.weishengjuzhanghao = obj[o];
	    this.ro.weishengjuzhanghao = true;
            continue;
          }
          if(o=='mima'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `weishengju/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.weishengjuCrossAddOrUpdateFlag = false;
                  this.parent.search();
