<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="卫生室账号" prop="weishengshizhanghao">
          <el-input v-model="ruleForm.weishengshizhanghao" 
              placeholder="卫生室账号" clearable  :readonly="ro.weishengshizhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="卫生室账号" prop="weishengshizhanghao">
              <el-input v-model="ruleForm.weishengshizhanghao" 
                placeholder="卫生室账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="卫生室名" prop="weishengshiming">
          <el-input v-model="ruleForm.weishengshiming" 
              placeholder="卫生室名" clearable  :readonly="ro.weishengshiming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="卫生室名" prop="weishengshiming">
              <el-input v-model="ruleForm.weishengshiming" 
                placeholder="卫生室名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所属区域" prop="suoshuquyu">
          <el-input v-model="ruleForm.suoshuquyu" 
              placeholder="所属区域" clearable  :readonly="ro.suoshuquyu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所属区域" prop="suoshuquyu">
              <el-input v-model="ruleForm.suoshuquyu" 
...
export default {
  data() {
	...
	jine : false,
	jiesuanriqi : false,
	weishengshizhanghao : false,
	fuzerenxingming : false,
	weishengshiming : false,
	suoshuquyu : false,
	lianxidianhua : false,
	ispay : false,
      },
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiesuanriqi = true;
          ...
          if(o=='weishengshizhanghao'){
            this.ruleForm.weishengshizhanghao = obj[o];
	    this.ro.weishengshizhanghao = true;
            continue;
          }
	    ...
	    this.ro.fuzerenxingming = true;
          ...
          if(o=='weishengshiming'){
            this.ruleForm.weishengshiming = obj[o];
	    this.ro.weishengshiming = true;
            continue;
          }
          if(o=='suoshuquyu'){
            this.ruleForm.suoshuquyu = obj[o];
	    this.ro.suoshuquyu = true;
            continue;
          }
          if(o=='lianxidianhua'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.weishengshizhanghao!=''&&json.weishengshizhanghao){
              		this.ruleForm.weishengshizhanghao = json.weishengshizhanghao
		}
		if(json.fuzerenxingming!=''&&json.fuzerenxingming){
              		this.ruleForm.fuzerenxingming = json.fuzerenxingming
		}
		if(json.weishengshiming!=''&&json.weishengshiming){
              		this.ruleForm.weishengshiming = json.weishengshiming
		}
		if(json.suoshuquyu!=''&&json.suoshuquyu){
              		this.ruleForm.suoshuquyu = json.suoshuquyu
		}
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jiesuandingdan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiesuandingdanCrossAddOrUpdateFlag = false;
                  this.parent.search();
