<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="供应商账号" prop="gongyingshangzhanghao">
          <el-input v-model="ruleForm.gongyingshangzhanghao" 
              placeholder="供应商账号" clearable  :readonly="ro.gongyingshangzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="供应商账号" prop="gongyingshangzhanghao">
              <el-input v-model="ruleForm.gongyingshangzhanghao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="销售代理" prop="xiaoshoudaili">
          <el-input v-model="ruleForm.xiaoshoudaili" 
              placeholder="销售代理" clearable  :readonly="ro.xiaoshoudaili"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="销售代理" prop="xiaoshoudaili">
              <el-input v-model="ruleForm.xiaoshoudaili" 
                placeholder="销售代理" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  computed: {
    jine:{
      get: function () {
        return 1*this.ruleForm.goumaishuliang*this.ruleForm.yaopinjiage
      }
    },
  },
  created() {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gongyingshangzhanghao = true;
          ...
          if(o=='xiaoshoudaili'){
            this.ruleForm.xiaoshoudaili = obj[o];
	    this.ro.xiaoshoudaili = true;
            continue;
          }
          if(o=='lianxidianhua'){
      ...
      this.$http({
		...
		if(json.xiaoshoudaili!=''&&json.xiaoshoudaili){
              		this.ruleForm.xiaoshoudaili = json.xiaoshoudaili
		}
