<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="区域名" prop="quyuming">
          <el-input v-model="ruleForm.quyuming" 
              placeholder="区域名" clearable  :readonly="ro.quyuming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="区域名" prop="quyuming">
              <el-input v-model="ruleForm.quyuming" 
                placeholder="区域名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='quyuming'){
            this.ruleForm.quyuming = obj[o];
	    this.ro.quyuming = true;
            continue;
          }
        }
      }
