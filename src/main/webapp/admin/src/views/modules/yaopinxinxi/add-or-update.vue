<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="药品库存" prop="yaopinkucun">
          <el-input v-model="ruleForm.yaopinkucun" 
              placeholder="药品库存" clearable  :readonly="ro.yaopinkucun"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="药品库存" prop="yaopinkucun">
              <el-input v-model="ruleForm.yaopinkucun" 
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.baozhiqi = true;
          ...
          if(o=='yaopinkucun'){
            this.ruleForm.yaopinkucun = obj[o];
	    this.ro.yaopinkucun = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.yaopinshuoming = this.ruleForm.yaopinshuoming.replace(reg,'../../../ssmpev4c/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
